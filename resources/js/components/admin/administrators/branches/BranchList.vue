    ...
    <div class="db-card db-tab-div active">
        <div class="db-card-header border-none">
            ...
            <div class="db-card-filter">
                <TableLimitComponent :method="list" :search="branch.search" :page="paginationPage" />
                <BranchCreateComponent :props="branch" />
            </div>
        </div>
                    ...
                    <tr class="db-table-body-tr" v-for="branch in branches" :key="branch">
                        ...
                        <td class="db-table-body-td">
                            <div class="flex justify-start items-center sm:items-start sm:justify-start gap-1.5">
                                <SmIconSidebarModalEditComponent @click="edit(branch)" />
                                <SmIconDeleteComponent @click="destroy(branch.id)"
...
export default {
    ...
    methods: {
        ...
        list: function (page = 1) {
            this.loading.isActive = true;
            this.branch.search.page = page;
            this.$store.dispatch("branch/lists", this.branch.search).then((res) => {
                this.loading.isActive = false;
            }).catch((err) => {
                this.loading.isActive = false;
            });
