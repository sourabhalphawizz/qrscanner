            ...
            <div class="modal-body">
                <div class="flex items-center gap-2 mb-4">
                    <h3 class="text-sm leading-6 font-medium first-letter:uppercase text-heading">
                        {{ $t('label.quantity') }}:</h3>
                    <div class="flex items-center indec-group  px-2 py-1" >
                        <button @click.prevent="quantityDecrement"
                            class="fa-solid fa-minus text-[14px] w-[18px] h-[18px] leading-4 text-center   transition  hover:text-white indec-minus"></button>
                        ...
                        <button @click.prevent="quantityIncrement"
                            class="fa-solid fa-plus text-[14px] w-[18px] h-[18px] leading4 text-center  transition  hover:text-white indec-plus"></button>
                    </div>
                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center indec-group py-1 px-2">
                                                <button @click.prevent="addonQuantityDecrement(addon.id)"
                                                    class="fa-solid fa-minus text-[8px] w-4 h-4 leading-3 text-center hover:text-white indec-minus"></button>
                                                ...
                                                <button @click.prevent="addonQuantityIncrement(addon.id)"
                                                    class="fa-solid fa-plus text-[8px] w-4 h-4 leading-3 text-center hover:text-white indec-plus"></button>
                                            </div>
                                        </div>
                                    </div>
                                </slide>
