            ...
            <div class="product-card-list-content-group">
                ...
                <div class="product-card-list-footer-group">
                    ...
                    <button @click.prevent="variationModalShow(item)" data-modal="#item-variation-modal"
                        ...
                        <span class=" text-primary transition">{{ $t('button.add') }}</span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog max-w-[647px]" v-if="item">
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-auto">
                        <div class="flex items-start gap-2 mb-1">
                                                ...
                                                <img v-if="item.item_type === 5" src="../../../../../public/images/veg.png" alt="">
                                                <img v-if="item.item_type === 10" src="../../../../../public/images/non-veg.png" alt="">
            ...
            <div class="modal-body">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div class="flex items-center indec-group py-1 px-2 ">
                        <button @click.prevent="quantityDecrement"
                            class="fa-solid fa-minus text-[14px] w-[18px] h-[18px] leading-4 text-center hover:text-white indec-minus"></button>
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center indec-group py-1 px-2">
                                                <button @click.prevent="addonQuantityDecrement(addon.id)"
                                                    class="fa-solid fa-minus text-[14px] w-4 h-4 leading-3 text-center hover:bg-primary hover:text-white indec-minus"></button>
                                                ...
                                                <button @click.prevent="addonQuantityIncrement(addon.id)"
                                                    class="fa-solid fa-plus text-[14px] w-4 h-4 leading-3 text-center hover:bg-primary hover:text-white indec-plus"></button>
                                            </div>
                                        </div>
                                    </div>
                                </slide>
                ...
                <button type="button" :disabled="temp.total_price <= 0" @click.prevent="addToCart"
                    class="flex items-center justify-center gap-3  text-base py-2 px-2 font-medium w-full text-white bg-primary btn-place_order">
...
export default {
    ...
    methods: {
        ...
        variationModalShow: function (item) {
            ...
            this.temp.item_type = this.item.item_type;
