        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="gstin" class="db-field-title">{{
                            $t("label.gstin")
                        }}</label>
                        <input v-model="props.form.gstin" v-bind:class="errors.gstin ? 'invalid' : ''" type="text"
                            id="gstin" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.gstin">{{
                            errors.gstin[0]
                        }}</small>
                    </div>
                    <div class="form-col-12 sm:form-col-6">
                        <label for="fssai" class="db-field-title">{{
                            $t("label.fssai")
                        }}</label>
                        <input v-model="props.form.fssai" v-bind:class="errors.name ? 'invalid' : ''" type="text"
                            id="fssai" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.fssai">{{
                            errors.fssai[0]
                        }}</small>
                    </div>


                    <div class="form-col-12 sm:form-col-6" v-if="false">
