...
import PlanComponent from "../../components/admin/settings/Plan/PlanComponent";
import PlanListComponent from "../../components/admin/settings/Plan/PlanListComponent";
...
export default [
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "admin.settings.plan",
                redirect: { name: "admin.settings.plan.list" },
                meta: {
                    isFrontend: false,
                    auth: true,
                    permissionUrl: "settings",
