                    ...
                    <td class="pl-3 py-3 last:pr-3 align-top border-b border-[#EFF0F6]">
                        <div class="flex items-center indec-group py-1 px-2">
                            <button @click.prevent="cartQuantityDecrement(index)"
                                ...
                                class="fa-solid text-[14px] w-[18px] h-[18px] leading-4 text-center  hover:bg-primary hover:text-white indec-minus"></button>
                            ...
                            <button @click.prevent="cartQuantityIncrement(index)"
                                class="fa-solid fa-plus text-[14px] w-[18px] h-[18px] leading4 text-center  hover:bg-primary hover:text-white indec-plus"></button>
                        </div>
                    </td>
