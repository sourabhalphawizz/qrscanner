...
use App\Http\Controllers\Admin\AdministratorSubscriptionController;
...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('administrator')->name('administrator.')->group(function () {
        ...
        Route::get('/subscription/{administrator}', [AdministratorSubscriptionController::class, 'index']);
        Route::get('/subscription/show/{administrator}/{subscription}', [AdministratorSubscriptionController::class, 'show']);
        Route::post('/subscription/{administrator}', [AdministratorSubscriptionController::class, 'store']);
        Route::match(
            ['put', 'patch'],
            '/subscription/{administrator}/{subscription}',
            [AdministratorSubscriptionController::class, 'update']
        );
        Route::delete('/subscription/{administrator}/{subscription}', [AdministratorSubscriptionController::class, 'destroy']);
    });
