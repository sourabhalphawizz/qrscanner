        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title">{{ $t("label.type") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input type="radio" v-model="props.form.type" id="type"
                                        :value="'offer'" class="custom-radio-field" checked />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="offer" class="db-field-label">{{
                                    $t("label.offer")
                                    }}</label>
                            </div>
                            <div class="db-field-radio">
                                ...
                                <label for="coupon" class="db-field-label">{{
                                    $t("label.coupon")
                                }}</label>
                            </div>
                        </div>
